'use client';
import { Clock, DollarSign, SortAsc } from 'lucide-react';
...
const CollectionSort: React.FC<CollectionSortProps> = ({ onSort, activeSort }) => {
    ...
    return (
        <div className="flex flex-wrap gap-2 p-4 bg-zinc-900/50 rounded-lg border border-zinc-800/50 font-roboto">
